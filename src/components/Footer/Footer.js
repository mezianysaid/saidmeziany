          ...
          <Grid container pt={6}>
            <Grid item xs={12} lg={4} md={4} className="rights">
              <Typography className="typo">
                Meziany Said :copyright ©️ {currentDate} all rights reserved
              </Typography>
            </Grid>
            <Grid item xs={12} lg={4} md={4} className="info">
              <Typography className="typo">
                {" "}
                📧 :mezianysaid@gmail.com
              </Typography>
              <Typography className="typo"> 📞 :+212703591549</Typography>
            </Grid>
            <Grid item xs={12} lg={4} md={4} className="socials" columnGap={2}>
              <Avatar
                component="a"
                className="icon"
                href="https://github.com/mezianysaid?tab=repositories"
              >
